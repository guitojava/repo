...
public class Command {
	...
	private String name;
	private static final Map<String, Command> getCommands = new HashMap<String, Command>(4);
	...
	/** GET command <code>DeleteFile</code> */
	public static final Command DELETE_FILE = new Command("DeleteFile");
	...
	static {
		...
		getCommands.put(DELETE_FILE.getName(), DELETE_FILE);
