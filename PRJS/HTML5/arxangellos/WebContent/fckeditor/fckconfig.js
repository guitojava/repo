...
FCKConfig.Plugins.Add( 'paypal' , 'en');
FCKConfig.Plugins.Add( 'youtube', 'en' ) ;
FCKConfig.Plugins.Add( 'insertHtml', 'en');
FCKConfig.Plugins.Add( 'googlemaps', 'en') ;


FCKConfig.GoogleMaps_Key = 'ABQIAAAAUP8CNZ26rvxzEDml_jD9YhS7Vbm9r3WkGTQZtVusKQOQMd6g_BT8WrJgBNfnEoK82bzU-OoQErvvEw'; // leoninternet
//'ABQIAAAAlXu5Pw6DFAUgqM2wQn01gxT2yXp_ZAY8_ufC3CFXhHIE1NvwkxSy5hTGQdsosYD3dz6faZHVrO-02A' ; // localhost


FCKConfig.GoogleMaps_CenterLat = 37.9646992 ;
FCKConfig.GoogleMaps_CenterLon = 23.7267834;
FCKConfig.GoogleMaps_Zoom = 11 ;
...
/*FCKConfig.insertHtml_snippets = {
	...
	*/
	...
	FCKConfig.insertHtml_snippets = {'ΕΙΣΑΓΩΓΗ ΚΩΔΙΚΑ HTML : ':''};
	...
	FCKConfig.insertHtml_showTextarea = true;
	// the size of the textarea in the dialog, in px
	FCKConfig.insertHtml_textareaWidth = 400;
	FCKConfig.insertHtml_textareaHeight = 150;
...
FCKConfig.ToolbarSets["Default"] = [
	[ 'Save', 'Preview', 'Templates',  'DocProps', '-', 'Table', 'Image','Flash','YouTube','googlemaps','My_Skype', 'paypal'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Rule','Smiley','SpecialChar','Equation','PageBreak'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor' ,'Source' , 'insertHtml']
] ;
...
FCKConfig.EnterMode = 'br' ;		//  must be br   as  it creates error on ie	// p | div | br
...
// for java 
var _FileBrowserExtension = 'java';
var _QuickUploadExtension = 'java';
