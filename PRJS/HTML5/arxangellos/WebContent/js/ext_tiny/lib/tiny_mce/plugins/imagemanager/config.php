<?php
	...
	$mcImageManagerConfig['general.tools'] = "upload,refresh,insert,delete"; // "filemanager" button if you have "filemanager.urlprefix" configured.
		
	$mcImageManagerConfig['general.disabled_tools'] = "createdir,edit,preview";
...
$mcImageManagerConfig['general.plugins'] = ""; // comma seperated
	...
	$mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/mipClubs"; // domain name
	...
	$mcImageManagerConfig['upload.max_width'] = "200"; // Only if force_width_height is true
	$mcImageManagerConfig['upload.max_height'] = "100"; // Only if force_width_height is true
